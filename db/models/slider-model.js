...
const Sliders = mongoose.model('sliders', SlidersSchema); //Compliling the UserSchema to commerceFox registered users model


// Exporting the model to be used by other modules

module.exports = Sliders; //exporting the model Users
